...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={`[&>tr:last-child]:border-0 border-b dark:border-gray-800 ${className}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`bg-blue-500 font-medium text-white ${className}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={`border-b transition-colors hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800 ${className}`}
    {...props}
  />
));
